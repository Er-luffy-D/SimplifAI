  ...
  const milestones = [
    {
      ...
      description:
        "Started with a vision to revolutionize learning through AI.",
    ...
    },
    {
      ...
      description:
        "Reached our first milestone with a working AI prototype for document summarization",
    ...
    },
    {
      ...
      description:
        "Currently integrating RAG (Retrieval-Augmented Generation) for enhanced learning experiences",
    ...
    },
    {
      ...
      event: "Target",
      description:
        "Aim to launch our first public beta with core features and initial user base",
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black text-white">
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none">
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-morphing"
          data-parallax="0.3"
        />
        <div
          className="absolute top-3/4 right-1/4 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-float-slower"
          data-parallax="0.5"
        />
        <div
          className="absolute top-1/2 left-1/2 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl animate-float"
          data-parallax="0.2"
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-green-500/10 rounded-full blur-3xl animate-float-slow"
          data-parallax="0.4"
        />
      </div>
      ...
      <div className="relative z-0 container mx-auto px-4 py-10 sm:py-20">
        <div className="text-center max-w-5xl mx-auto">
          <div
            className="inline-flex items-center justify-center px-4 py-2 mb-8 text-sm font-medium rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 animate-glow"
          ...
          <h1
            className="text-4xl sm:text-5xl md:text-7xl font-black mb-8"
          ...
          <p
            ...
            data-animate="fade-up"
          >
            We&apos;re on a mission to make learning more efficient, engaging,
            and accessible for everyone. Our cutting-edge AI transforms how
            people consume, understand, and retain information.
          </p>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          <div data-animate="slide-left">
            <h2 className="text-4xl font-bold mb-8" data-animate="text-reveal">
              Our Mission
            </h2>
            <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
              <p data-animate="fade-up">
                Traditional learning methods often leave students overwhelmed,
                disengaged, and struggling to retain information. We saw an
                opportunity to change that fundamentally.
              </p>
              <p data-animate="fade-up">
                Our AI-powered platform transforms dense, complex documents into
                personalized learning experiences that adapt to each
                individual&apos;s pace, style, and goals.
              </p>
              <p data-animate="fade-up">
                We believe that with the right tools, anyone can master any
                subject. That&apos;s why we&apos;re building the future of
          ...
          <div className="relative" data-animate="slide-right">
            <div
              className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl blur-3xl animate-pulse-gentle"
              data-parallax="0.1"
            />
            <Card
            ...
            >
              <CardContent className="p-12 text-center">
                ...
                <p
                  ...
                  data-animate="fade-up"
                >
                  SimplifAI was born out of a simple idea: to make learning
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6" data-animate="text-reveal">
            Our Core Values
          </h2>
          <p
            ...
            >
              <CardHeader className="pb-6">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <CardTitle
                      className="text-xl mb-3 group-hover:text-purple-400 transition-colors duration-300"
                      data-animate="text-reveal"
                    >
                      {value.title}
                    </CardTitle>
              ...
              >
                ...
                >
                  <CardHeader>
                    ...
                    <CardTitle
                      className="text-xl group-hover:text-purple-400 transition-colors duration-300"
                      data-animate="text-reveal"
                    >
                      {milestone.event}
                    </CardTitle>
          ...
          {team.map((member, index) => (
            ...
            >
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle
                  className="text-lg mb-2 group-hover:text-purple-400 transition-colors duration-300"
                  data-animate="text-reveal"
                >
                  {member.name}
                </CardTitle>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className="relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-3xl p-12 border border-purple-500/20 backdrop-blur-sm"
            data-animate="scale-in"
          >
            <div
              className="absolute inset-0 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-3xl blur-xl"
              data-parallax="0.1"
            />
            <div className="relative z-10">
              ...
              <p
                ...
                data-animate="fade-up"
              >
                Whether you&apos;re a learner looking to accelerate your
                education or a developer wanting to contribute to the future of
                learning, we&apos;d love to have you on board.
              </p>
              <div
              ...
              >
                <MagneticButton
                  ...
                  onClick={() =>
                    window.open("https://simplif-ai-xi.vercel.app/", "_blank")
                  }
                ...
                <MagneticButton
                  ...
                  onClick={() =>
                    window.open(
                      "https://linkedin.com/in/piyushdixitizme",
                      "_blank"
                    )
                  }
                  cursorText="Connect"
