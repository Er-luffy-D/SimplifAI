            ...
            >
              ...
              <Card
                className={`relative h-full bg-gray-900/50 backdrop-blur-sm border-0 overflow-hidden transition-all duration-500 group-hover:scale-105 ${
                  plan.popular ? "ring-2 ring-purple-500/50 shadow-2xl shadow-purple-500/20" : "border border-gray-800 hover:border-gray-700"
                }`}
                data-animate="rotate-in"
              >
                {/* Gradient border effect */}
                <div className={`absolute inset-0 bg-gradient-to-r ${plan.borderGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg`} />
                ...
                <div className="relative z-10 p-8">
                  <CardHeader className="text-center pb-8 px-0">
                    ...
                    <CardTitle className="text-2xl font-bold mb-2" data-animate="text-reveal">
                      {plan.name}
                    </CardTitle>
                    <CardDescription className="text-gray-400 mb-6" data-animate="fade-up">
                      {plan.description}
                    </CardDescription>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6" data-animate="stagger">
          {faqs.map((faq, index) => (
            ...
            >
              <CardHeader>
                <CardTitle className="text-lg text-white" data-animate="text-reveal">
                  {faq.question}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 leading-relaxed" data-animate="fade-up">
                  {faq.answer}
                </p>
              </CardContent>
            </Card>
