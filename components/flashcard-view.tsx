        ...
        <div className="flex flex-col items-center animate-fade-in">
            <div className="w-full max-w-2xl mb-8">
                ...
                <div className="flex w-full items-center justify-center gap-2 sm:gap-4">
                    <Button
                        onClick={prevCard}
                        className="shrink-0 w-2 h-40 sm:w-2 sm:h-28 md:w-2 md:h-50 hover:scale-110 bg-neutral-900 hover:bg-neutral-700 text-white transition-all duration-300 flex items-center justify-center hover:cursor-pointer"
                    >
                    ...
                    <Button
                        onClick={nextCard}
                        className="shrink-0 w-2 h-24 sm:w-2 sm:h-40 md:w-2 md:h-50 hover:scale-110 bg-neutral-900 hover:bg-neutral-700 text-white transition-all duration-300 flex items-center justify-center hover:cursor-pointer"
                    >
            ...
            <div className="flex items-center justify-center gap-6">
                <Button
                    ...
                    variant="outline"
                    size="icon"
                    className="hover:scale-110 hover:bg-primary/10 transition-all duration-300 hover:cursor-pointer"
                >
