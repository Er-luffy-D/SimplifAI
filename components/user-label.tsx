...
export function UserLabel() {
  ...
  // Fixed position with offset so it doesn't overlap sticky header.
  // top-6 on mobile, top-[84px] on md+ (adjust to match your header height).
  return (
    <div
      className="fixed right-5 top-6 md:top-[84px] z-40 md:z-50 flex items-center"
      ref={menuRef}
